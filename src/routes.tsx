...
import { CATEGORY, CATEGORY_DETAIL, CLIENTS, GOODS, GOODS_DETAIL, NOTIFICATION, NOTIFICATION_DETAIL } from 'constants/urls';
...
const GoodsDetailView = lazy(() => import('views/admin/goods/GoodsDetailView'));
